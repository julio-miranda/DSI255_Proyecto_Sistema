    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try {
            ...
            for (DocumentSnapshot document : querySnap.get().getDocuments()) {
                if (email.equals(document.getString("Correo")) && (password.equals(document.getString("Password")) || hashDeContraseña(password).equals(document.getString("Password")))) {
                    JOptionPane.showMessageDialog(this, "Bienvenido " + document.getString("Nombre"));
                    tipoUsuario(document.getString("Tipo_de_Usuarios"), document.getString("Puesto"));
                } else if (!email.equals(document.getString("Correo")) && (!password.equals(document.getString("Password")) && !hashDeContraseña(password).equals(document.getString("Password")))) {
                    id += 1;
                    if (id == 1) {
